        ...
        section.forEach(entity => {
            if (entity['__type__'] == 'checkpoint') {
                ...
                if (index === 17 || index === 33 || index === 41) {
                    itemsToAdd.push(main.entity('merchant_board', {x: entity.x + 50, y: entity.y}));
                    if (index === 17) {
                        itemsToAdd.push(main.entity('mysterious_person', {x: entity.x + 140, y: entity.y}));
                    } else if (index === 33) {
                        itemsToAdd.push(main.entity('wandering_hunter', {x: entity.x + 140, y: entity.y + 32}));
                    } else if (index === 41) {
                        itemsToAdd.push(main.entity('priest', {x: entity.x + 140, y: entity.y}));
                    }
                    itemsToAdd.push(main.entity('albularyo', {x: entity.x + 220, y: entity.y}));
                }
            }
        });
